...
public class XLSWriter {
	...
	private enum Kolumna {
		Kod(0), Nazwa(1), Nazwa2(2), Nazwa3(3), Telefon(4), Telefon2(5), TelefonSms(6), Fax(7), Ulica(8), NrDomu(
				9), NrLokalu(10), KodPocztowy(11), Poczta(12), Miasto(13), Kraj(14), Wojewodztwo(15), Powiat(
						16), Gmina(17), URL(18), Grupa(19), OsobaFizyczna(20), NIP(21), NIPKraj(22), Zezwolenie(
								23), Regon(24), Pesel(25), Email(26), BankRachunerNr(27), BankNazwa(28), Osoba(
										29), Opis(30), Rodzaj(31), PlatnikVAT(32), PodatnikVATCzynny(33), Eksport(
												34), LimityKredytu(
														35), Termin(36), FormaPlatnosci(37), Ceny(38), CenyNazwa(
																39), Upust(40), NieNaliczajOdsetek(41), MetodaKasowa(
																		42), WindykacjaEMail(43), WindykacjaTelefonSMS(
																				44), AlgorytmNettoBrutto(
																						45), Waluta(46);
		...
		try {
			...
			for (Faktura f : faktury) {
				...
				if (!clientName.contains(klient.nazwa)) {
					...
					row.createCell(Kolumna.Kod.getNrKolumny()).setCellValue(
							klient.skroconaNazwa.substring(0, Math.min(klient.skroconaNazwa.length(), 20)));
